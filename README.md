...
<img src="demo/Admin%20management%20localdataset%2C%20feedback%20%26%20show%20user%20statistics.gif" width="80%" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
<br>
...
```
┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│   Mobile App    │────▶│  Azure Custom   │────▶│   Recognition   │
│   (Flutter)     │◀────│    Vision       │◀────│    Results      │
└─────────────────┘     └─────────────────┘     └─────────────────┘
         │                                                      
         ▼                                                      
┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│   Firebase      │────▶│   Recipe APIs   │────▶│   Nutritional   │
│   Auth/DB       │◀────│ (Spoonacular)   │◀────│   Information   │
└─────────────────┘     └─────────────────┘     └─────────────────┘
         │                                                      
         ▼                                                      
┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│   Web Platform  │────▶│   Gemini AI     │────▶│   AI Assistant  │
│   (Admin)       │◀────│   Assistant     │◀────│   Responses     │
└─────────────────┘     └─────────────────┘     └─────────────────┘
```
